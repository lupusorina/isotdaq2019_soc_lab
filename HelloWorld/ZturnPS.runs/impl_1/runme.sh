...
HD_PWD='/opt/Xilinx/Vivado/CERN_projects/HelloWorld/ZturnPS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PSDesign_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PSDesign_wrapper.tcl -notrace
