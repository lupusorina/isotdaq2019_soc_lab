...
xv_path="/media/sf_sorinalupu/VIvado_XILINX/Vivado/2016.3"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L processing_system7_bfm_v2_0_5 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot PSDesign xil_defaultlib.PSDesign xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim PSDesign -key {Behavioral:sim_1:Functional:PSDesign} -tclbatch cmd.tcl -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/media/sf_sorinalupu/VIvado_XILINX/Vivado/2016.3/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb PSDesign.wdb xsim.dir)
