...
HD_PWD='/home/sorina/Desktop/Laboratory/hdl/synthesis/vivado_project/LED_Buzzer_Control/LED_Buzzer_Control.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_BUZZER_BD_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LED_BUZZER_BD_wrapper.tcl
