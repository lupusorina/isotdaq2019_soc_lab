...
HD_PWD='/home/sorina/Desktop/Laboratory/hdl/synthesis/vivado_project/LED_Buzzer_Control/LED_Buzzer_Control.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_BUZZER_BD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LED_BUZZER_BD_wrapper.tcl -notrace
