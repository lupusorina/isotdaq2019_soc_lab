...
HD_PWD='/home/isotdaq/lab14/demo/hdl/synthesis/vivado_project/LEDBuzzer.runs/bd_pwm_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_pwm_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_pwm_auto_pc_0.tcl
