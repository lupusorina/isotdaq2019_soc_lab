...
HD_PWD='/home/isotdaq/lab14/demo/hdl/synthesis/vivado_project/LEDBuzzer.runs/bd_pwm_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_pwm_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_pwm_rst_ps7_0_50M_0.tcl
