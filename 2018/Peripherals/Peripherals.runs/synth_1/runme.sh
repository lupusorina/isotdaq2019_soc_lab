...
HD_PWD='/home/sorina/Desktop/Laboratory/cern_winter_school/2018/Peripherals/Peripherals.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Peripherals_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Peripherals_wrapper.tcl
