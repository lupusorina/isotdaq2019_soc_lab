...
HD_PWD='/home/sorina/Desktop/Laboratory/cern_winter_school/2018/Peripherals/Peripherals.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Peripherals_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Peripherals_wrapper.tcl -notrace
