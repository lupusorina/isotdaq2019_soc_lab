...
HD_PWD='/home/sorina/Desktop/Laboratory/cern_winter_school/2018/detector/detector.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log detector_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source detector_bd_wrapper.tcl -notrace
