...
HD_PWD='/home/sorina/Desktop/Laboratory/cern_winter_school/2018/detector/detector.runs/detector_bd_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log detector_bd_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source detector_bd_auto_pc_0.tcl
