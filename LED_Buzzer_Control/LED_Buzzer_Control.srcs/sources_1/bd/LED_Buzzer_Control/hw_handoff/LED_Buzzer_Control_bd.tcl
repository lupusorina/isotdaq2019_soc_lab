...
################################################################
# This is a generated script based on design: LED_Buzzer_Control
#
...
# source LED_Buzzer_Control_script.tcl
...
set design_name LED_Buzzer_Control
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins PWM_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
...
#  -string -flagsOSRD
preplace port PWM_GREEN -pg 1 -y 310 -defaultsOSRD
preplace port PWM_BUZZER -pg 1 -y 350 -defaultsOSRD
preplace port PWM_RED -pg 1 -y 290 -defaultsOSRD
preplace port rgb_led -pg 1 -y 10 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 240 -defaultsOSRD
preplace port PWM_BLUE -pg 1 -y 330 -defaultsOSRD
preplace inst PWM_0 -pg 1 -lvl 3 -y 320 -defaultsOSRD
...
preplace netloc PWM_0_PWM_BUZZER 1 3 1 NJ
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 450 340 N
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 20 10 410
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 240 NJ 240 NJ
preplace netloc PWM_0_PWM_BLUE 1 3 1 NJ
preplace netloc PWM_0_PWM_GREEN 1 3 1 NJ
preplace netloc PWM_0_PWM_RED 1 3 1 NJ
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 740
preplace netloc processing_system7_0_FCLK_CLK2 1 0 3 30 190 440 280 730
preplace netloc rst_ps7_0_100M_interconnect_aresetn 1 1 1 430
levelinfo -pg 1 0 220 590 870 1020 -top -10 -bot 400
",
}
