...
HD_PWD='/opt/Xilinx/Vivado/CERN_projects/LED_Buzzer_Control/LED_Buzzer_Control.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_Buzzer_Control_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LED_Buzzer_Control_wrapper.tcl -notrace
