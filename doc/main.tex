...
To generate the bitstream, look into the Flow Manager (Figure X) and press \textbf{Generate Bitstream}. You will need to wait a bit longer until the bitstream is created. Check for errors in the process. 
