...
\title{ \normalsize \textsc{The International School of Trigger and Data Acquisition \\ 2017}
		\\ [2.0cm]
		\HRule{0.5pt} \\
...
\begin{minipage}{.425\textwidth}
  \centering
  \includegraphics[width=\linewidth]{img/diag_processor.png}
\end{minipage}%
\begin{minipage}{.425\textwidth}
  \centering
  \includegraphics[width=\linewidth]{img/diagram_pwm.png}
\end{minipage}
