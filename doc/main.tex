...
To export the hardware, press File $->$ Edit $->$ Export $->$ Export Hardware. Thick \textit{Include bitstream} like in Figure \ref{fig:export_hardware_generate_bitstream}.
...
To open it, press File $->$ Launch SDK. Now, the hardware shall be automatically 
imported in XSDK.
